...
class PaddockScene(Scene):
    ...
    def choose_runing_style(self, style: int):
        rp = action.resize_proxy()
        button_pos = {
            Context.RUNING_STYLE_LEAD: rp.vector2((60, 500), 466),
            Context.RUNING_STYLE_HEAD: rp.vector2((160, 500), 466),
            Context.RUNING_STYLE_MIDDLE: rp.vector2((260, 500), 466),
            Context.RUNING_STYLE_LAST: rp.vector2((360, 500), 466),
        }[style]
