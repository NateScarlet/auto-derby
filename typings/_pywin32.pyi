from typing import Any, Dict, Literal, Text, Tuple, TypeVar, Union, overload, type_check_only
...
class PyCDC(PyAssocObject):
    ...
    def BitBlt(self, destPos: Tuple[int,int], size: Tuple[int,int], dc: PyCDC, srcPos: Tuple[int,int], rop: int) -> None:
...
. Defaults to ....
    ...
    def Paint(self, dcObject: PyCDC, rectDest: Tuple[int,int,int,int]=..., rectSrc: Tuple[int,int,int,int]=...) -> None:
        """Paint a bitmap.
