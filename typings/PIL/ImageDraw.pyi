...
class ImageDraw:
    ...
    def line(
        ...
        fill: _Ink | None = ...,
        width: float = ...,
        joint: Literal["curve"] | None = ...,
    ) -> None: ...
    def shape(
        self, shape: _Outline, fill: _Ink | None = ..., outline: _Ink | None = ...
    ) -> None: ...
    def pieslice(
        self,
    ...
    def polygon(
        self, xy: _XY, fill: _Ink | None = ..., outline: _Ink | None = ...
    ) -> None: ...
    def regular_polygon(
        self,
...
@overload
def getdraw(
    im: None = ..., hints: Container[Literal["nicest"]] | None = ...
) -> tuple[None, Any]: ...
@overload
def getdraw(
    im: Image, hints: Container[Literal["nicest"]] | None = ...
) -> tuple[Image, Any]: ...
def floodfill(
    image: Image, xy: tuple[float, float], value, border=..., thresh: float = ...
) -> None: ...
