...
class Image:
    ...
    def getpixel(self, xy: tuple[int, int]) -> Union[Tuple[int, ...], int]: ...
    ...
    def paste(
        self,
        im: Image,
        box: tuple[float, float] | _Box | None = ...,
        mask: Image | None = ...,
    ) -> None: ...
    def alpha_composite(
        self, im: Image, dest: tuple[int, int] = ..., source: tuple[int, int] = ...
    ) -> None: ...
    ...
    def putpalette(
        self,
        data: ImagePalette | bytes | Iterable[int] | SupportsBytes,
        rawmode: str | None = ...,
    ) -> None: ...
...
def new(
    mode: _Mode, size: tuple[int, int], color: float | Tuple[float, ...] = ...
) -> Image: ...
def frombytes(
    mode: _Mode, size: tuple[int, int], data: Any, decoder_name: str = ..., *args: Any
) -> Image: ...
def frombuffer(
    mode: _Mode, size: tuple[int, int], data: Any, decoder_name: str = ..., *args: Any
) -> Image: ...
def fromarray(obj: Any, mode: _Mode | None = ...) -> Image: ...
